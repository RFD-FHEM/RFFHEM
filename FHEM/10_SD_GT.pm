#################################################################
# $Id: 10_SD_GT.pm 0 2026-09-20 19:50:34Z sidey79 $
#
...
sub Parse {
  ...
  ### additional test from state, as sometimes the state is unknown when receiving --> PEARL WARNING: Interception
  if (not defined $state) { $state = "status unknown, please press another button" };
