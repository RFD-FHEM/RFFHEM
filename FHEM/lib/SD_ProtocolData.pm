...
{ 
	...
	our %protocols = (
		"0"	=>	## various weather sensors (500 | 9100)
						# ABS700 | T: 3.3, Bat:low          MS;P1=-7949;P2=492;P3=-1978;P4=-3970;D=21232423232424242423232323232324242423232323232424;CP=2;SP=1;R=245;O;
						# Mebus | T: 1.9, Bat:low           MS;P0=-9298;P1=495;P2=-1980;P3=-4239;D=1012121312131313121313121312121212121212131212131312131212;CP=1;SP=0;R=223;O;m2;
						# GT_WT_02 | T: 2.9 H: 86, Bat:ok   MS;P0=531;P1=-9027;P3=-4126;P4=-2078;D=0103040304040403030404040404040404040404030303040303040304030304030304040403;CP=0;SP=1;R=249;O;m2;
						# Prologue 145 | T: 2.6, Bat:ok     MS;P0=-4152;P1=643;P2=-2068;P3=-9066;D=1310121210121212101210101212121212121212121212121010121012121212121012101212;CP=1;SP=3;R=220;O;m2;
						# Prologue 145 | T: 2.7, Bat:ok     MS;P0=-4149;P2=-9098;P3=628;P4=-2076;D=3230343430343434303430303434343434343434343434343030343030343434343034303434;CP=3;SP=2;R=218;O;m2;
			{
				name						=> 'weather (v1)',
		...
		"0.1"	=>	## other Sensors  (380 | 9650)
							# Mebus 237 | T: 1.3, Bat:low   MS;P1=416;P2=-9618;P3=-4610;P4=-2036;D=1213141313131313141313141314141414141414141313141314131414;CP=1;SP=2;R=220;O;m0;
							# Mebus 151 | T: 1.2, Bat:low   MS;P0=-9690;P3=354;P4=-4662;P5=-2107;D=3034343434343535343534343435353535353535353434353535343535;CP=3;SP=0;R=209;O;m2;
							# https://github.com/RFD-FHEM/RFFHEM/issues/63 @localhosthack0r
							# AURIOL 255 | T: 0.0, Bat:ok | LIDL Wetterstation   MS;P1=367;P2=-2077;P4=-9415;P5=-4014;D=141515151515151515121512121212121212121212121212121212121212121212;CP=1;SP=4;O;
			{
				name						=> 'weather (v2)',
				comment					=> 'temperature / humidity or other sensors',
				id							=> '0.1',
		...
		"0.2"	=>	## other Sensors | for sensors how tol is runaway (260+tol | 9650)
							# Mebus 151 | T: 0.4, Bat:low   MS;P1=-2140;P2=309;P3=-4690;P4=-9695;D=2421232323232121232123232321212121212121212123212121232121;CP=2;SP=4;R=211;m1;
							# Mebus 151 | T: 0.3, Bat:low   MS;P0=-9703;P1=304;P2=-2133;P3=-4689;D=1012131312131212131213131312121212121212121212131312131212;CP=1;SP=0;R=208;
							# no decode!                    MS;P0=138;P1=-2140;P2=315;P3=-9704;P4=-4713;P5=234;D=2321212421242454210424212421512121215121512124212121542121;CP=2;SP=3;R=210;
			{
				name						=> 'weather (v3)',
				comment					=> 'temperature / humidity or other sensors',
				id							=> '0.2',
		...
		"0.3"	=>	## Pollin PFR-130
							...
							# Ventus W174 | rain: 103.25   MS;P3=-2009;P4=479;P5=-9066;P6=-4047;D=45434343464343434643464643464643434643464646434346464343434343434346464643;CP=4;SP=5;R=55;O;m2;
			{
				name					=> 'weather (v4)',
		...
		"0.4"	=>	## Auriol Z31092  (450 | 9200)
							# AURIOL 95 | T: 6.1, Bat:low    MS;P0=443;P3=-9169;P4=-1993;P5=-3954;D=030405040505050505050404040404040404040505050504050405050504040405;CP=0;SP=3;R=14;O;m0;
							# AURIOL 190 | T: 2.8, Bat:low   MS;P0=-9102;P1=446;P2=-3956;P3=-2008;D=10121312121212121312131213131313131313131212121313121213121213121314;CP=1;SP=0;R=212;O;m2;
			{
				name					=> 'weather (v5)',
		...
		"7"	=>	## weather sensors like EAS800z
						# T: 19.8 H: 11, Bat:low   MS;P1=-3882;P2=504;P3=-957;P4=-1949;D=21232424232323242423232323232323232424232323242423242424242323232324232424;CP=2;SP=1;R=249;m=2;
			{
				name						=> 'weather',
		...
		"8"	=>	## TX3 (ITTX) Protocol
						# T: 24.4   MU;P0=-1046;P1=1339;P2=524;P3=-28696;D=010201010101010202010101010202010202020102010101020101010202020102010101010202310101010201020101010101020201010101020201020202010201010102010101020202010201010101020;CP=2;R=4;
			{
				name						=> 'TX3 Protocol',
				id							=> '8',
				knownFreqs      => '',
		...
		"12"	=>	## Hideki
							# T: 22.7, Bat:ok   MC;LL=-1040;LH=904;SL=-542;SH=426;D=A8C233B53A3E0A0783;C=485;L=72;R=213;
			{
				name						=> 'Hideki',
				comment					=> 'temperature / humidity or other sensors',
				id							=> '12',
		...
		"18"	=>	## Oregon Scientific v1
							# T: 7.5 BAT:ok   MC;LL=-2721;LH=3139;SL=-1246;SH=1677;D=1A51FF47;C=1463;L=32;R=12;
			{
		...
		"32"	=>	## FreeTec PE-6946
							...
							# 154FFF | ring   MU;P0=-6676;P1=578;P2=-278;P4=-680;P5=176;P6=-184;D=541654165412545412121212121212121212121250545454125412541254125454121212121212121212121212;CP=1;R=0;
							# 154FFF | ring   MU;P0=146;P1=245;P3=571;P4=-708;P5=-284;P7=-6689;D=14351435143514143535353535353535353535350704040435043504350435040435353535353535353535353507040404350435043504350404353535353535353535353535070404043504350435043504043535353535353535353535350704040435043504350435040435353535353535353535353507040404350435;CP=3;R=0;O;
							# 154FFF | ring   MU;P0=-6680;P1=162;P2=-298;P4=253;P5=-699;P6=555;D=45624562456245456262626262626262626262621015151562156215621562151562626262626262626262626210151515621562156215621515626262626262626262626262;CP=6;R=0;
			{
		...
		"37"	=>	## Bresser 7009994
							...
							# T: 22.7 H: 48, Bat:ok   MU;P0=729;P1=-736;P2=483;P3=-251;P4=238;P5=-491;D=010101012323452323454523454545234523234545234523232345454545232345454545452323232345232340;CP=4;
							# T: 22.7 H: 48, Bat:ok   MU;P0=-790;P1=-255;P2=474;P4=226;P6=722;P7=-510;D=721060606060474747472121212147472121472147212121214747212147474721214747212147214721212147214060606060474747472121212140;CP=4;R=216;
		...
		"46"	=>	## Tedsen Fernbedienungen u.a. für Berner Garagentorantrieb GA401 und Geiger Antriebstechnik Rolladensteuerung
							...
							# Button_1 | tristateCode=F1FF11F10   MU;P0=-15829;P1=-3580;P2=1962;P3=-330;P4=245;P5=-2051;D=1234523232345234523232323234523234540 0 2345 2323 2345 2345 2323 2323 2345 2323 454 023452323234523452323232323452323454023452323234523452323232323452323454023452323234523452323232323452323454023452323234523452323;CP=2;
							# Button_1 | tristateCode=F1FF11F10   MU;P0=-1943;P1=1966;P2=-327;P3=247;P5=-15810;D=012301212123012301212121212301212303           5 1230 1212 1230 1230 1212 1212 1230 1212 303 5 1230 1212 1230 1230 1212 1212 1230 1212 303 51230121212301230121212121230121230351230121212301230121212121230121230351230;CP=1;
		...
		"50"	=>	## Opus XT300
							...
							# T: 25 H: 5   MU;P0=248;P1=-21400;P2=545;P3=-925;P4=1368;P5=-12308;D=01232323232323232343234323432343234343434343234323432343434343432323232323232323232343432323432345232323232323232343234323432343234343434343234323432343434343432323232323232323232343432323432345232323232323232343234323432343234343434343234323432343434343;CP=2;O;
			{
				name						=> 'Opus_XT300',
		...
		"57"	=>	## m-e doorbell fuer FG- und Basic-Serie
							...
							# 2AA4A7 | ring   MC;LL=-653;LH=665;SL=-317;SH=348;D=D55B58;C=330;L=21;
							# 2AA4A7 | ring   MC;LL=-654;LH=678;SL=-314;SH=351;D=D55B58;C=332;L=21;
							# 2AA4A7 | ring   MC;LL=-653;LH=679;SL=-310;SH=351;D=D55B58;C=332;L=21;
			{
				name						=> 'm-e',
		...
		"58"	=>	## TFA 30.3208.0
							# T: 18.9 H: 69, Bat:ok   MC;LL=-981;LH=964;SL=-480;SH=520;D=002BA37EBDBBA24F0015D1BF5EDDD127800AE8DFAF6EE893C;C=486;L=194;
			{
				name				=> 'TFA 30.3208.0',
				comment				=> 'temperature / humidity sensor',
				id				=> '58',
		...
		"60"	=>	## ELV, LA CROSSE (WS2000/WS7000)
							# T: 21.3   MU;P0=32001;P1=-381;P2=835;P3=354;P4=-857;D=01212121212121212121343421212134342121213434342121343421212134213421213421212121342121212134212121213421212121343421343430;CP=2;R=53;
		...
		"66"	=>	## TX2 Protocol (Remote Temp Transmitter & Remote Thermo Model 7035)
							...
							# T: 23.2   MU;P0=13312;P1=-2785;P2=4985;P3=1124;P4=-6442;P5=3181;P6=-31980;D=0121345434545454545434545454543454545434343454543434545434545454545454343434545434343434545621213454345454545454345454545434545454343434545434345454345454545454543434345454343434345456212134543454545454543454545454345454543434345454343454543454545454545;CP=3;R=73;O;
			{
				name							=> 'WS7035',
		...
		"67"	=>	## TX2 Protocol (Remote Datalink & Remote Thermo Model 7053, 7054)
							...
							# T: 26.0   MU;P0=3381;P1=-672;P2=-4628;P3=1142;P4=-30768;D=010 2320232020202020232020232020202320232323202323202020202020202020 4 010 2320232020202020232020232020202320232323202323202020202020202020 0;CP=0;R=45;
							# T: 24.3   MU;P0=1148;P1=3421;P6=-664;P7=-4631;D=161 7071707171717171707171707171717171707070717071717171707071717171 0;CP=1;R=29;
		...
		"71"	=>	## PEARL infactory Poolthermometer (PV-8644)
							# T: 24.2   MU;P0=1735;P1=-1160;P2=591;P3=-876;D=0123012323010101230101232301230123010101010123012301012323232323232301232323232323232323012301012;CP=2;R=97;
			{
				name					=> 'PEARL',
		...
		"76"	=>	## Kabellose LED-Weihnachtskerzen XM21-0
							...
							# MU;P0=114;P1=-197;P2=419;D=0121212121010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101012121212101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010;CP=0;R=54;O;
		...
		"80"	=>	## EM1000WZ (Energy-Monitor) Funkprotokoll (868Mhz)  @HomeAutoUser | Derwelcherichbin
							# CNT:91 CUM:14.560 5MIN:0.240 TOP:0.170   https://github.com/RFD-FHEM/RFFHEM/issues/253
		...
		"81"	=>	## Remote control SA-434-1 based on HT12E @elektron-bbs
							# id:115 | receive   MU;P0=-485;P1=188;P2=-6784;P3=508;P5=1010;P6=-974;P7=-17172;D=0123050505630505056305630563730505056305050563056305637305050563050505630563056373050505630505056305630563730505056305050563056305637305050563050505630563056373050505630505056305630563730505056305050563056305637305050563050505630563056373050505630505056;CP=3;R=0;
							# id:115 | receive   MU;P0=-1756;P1=112;P2=-11752;P3=496;P4=-495;P5=998;P6=-988;P7=-17183;D=0123454545634545456345634563734545456345454563456345637345454563454545634563456373454545634545456345634563734545456345454563456345637345454563454545634563456373454545634545456345634563734545456345454563456345637345454563454545634563456373454545634545456;CP=3;R=0;
							#      __        ____
							# ____|  |    __|    |
							#  Bit 1       Bit 0
		...
		"85"	=>	## Funk Wetterstation TFA 35.1140.01 mit Temperatur-/Feuchte- und Windsensor TFA 30.3222.02 09/2018 @Iron-R
							...
							# no decode!                  MU;P0=-504;P1=481;P2=-254;P3=227;P4=723;P5=-739;P6=-1848;D=01230121212303030121230303030303030453030303012123030301230303012301212303030303030304530303030121230303012303030123012121230303012123030303030303030123030123030123030123012123030303030123012301230123012303012121212364545454530303030121230303012303030123;CP=3;R=45;O;
