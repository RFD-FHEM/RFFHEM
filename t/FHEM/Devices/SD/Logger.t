...
subtest 'Custom logMethod' => sub {
    ...
    FHEM::Devices::SD::Logger::Log($device_hash, 3, 'Test Message 1');
...
subtest 'Hash with NAME' => sub {
    ...
    $log3_calls = [];
    FHEM::Devices::SD::Logger::Log($device_hash, 4, 'Test Message 2');
...
subtest 'Device Name String' => sub {
    $log3_calls = [];
    FHEM::Devices::SD::Logger::Log('StringDevice', 1, 'Test Message 3');
...
subtest 'Generic Fallback' => sub {
    $log3_calls = [];
    FHEM::Devices::SD::Logger::Log(undef, 5, 'Test Message 4');
...
subtest 'Empty Hash Fallback' => sub {
    my $empty_hash = {};
    $log3_calls = [];
    FHEM::Devices::SD::Logger::Log($empty_hash, 2, 'Test Message 5');
