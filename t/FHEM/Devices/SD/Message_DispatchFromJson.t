...
subtest 'Erfolgreicher DispatchFromJson Aufruf' => sub {
    ...
    FHEM::Devices::SD::Message::json2Dispatch($valid_json, $device_name);
...
subtest 'Fehlender JSON-String ($json_str undef)' => sub {
    ...
    FHEM::Devices::SD::Message::json2Dispatch(undef, $device_name);
...
subtest 'Fehlender Device-Name ($name undef)' => sub {
    ...
    FHEM::Devices::SD::Message::json2Dispatch($valid_json, undef);
...
subtest 'Ungültiger JSON-String' => sub {
    ...
    FHEM::Devices::SD::Message::json2Dispatch($invalid_json, $device_name);
...
EOF
    ...
    FHEM::Devices::SD::Message::json2Dispatch($missing_dmsg_json, $device_name);
...
EOF
    ...
    FHEM::Devices::SD::Message::json2Dispatch($missing_id_json, $device_name);
...
subtest 'Testfall 9: Initialisierung überspringen (matchlist und clients sind definiert)' => sub {
    ...
    # Execute
    eval { FHEM::Devices::SD::Message::json2Dispatch($valid_json, $device_name); };
