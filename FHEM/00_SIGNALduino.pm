# $Id: 00_SIGNALduino.pm v3.5.2 2021-11-06 19:31:39Z elektron-bbs $
...
use constant {
  SDUINO_VERSION                  => '3.5.2+20211106',  # Datum wird automatisch bei jedem pull request aktualisiert
...
sub SIGNALduino_Parse_MU {
  ...
  if ($rmsg !~ /^MU;(?:P[0-7]=-?[0-9]+;){3,8}?((?:D=[0-7]+;)|(?:CP=[0-7];)|(?:R=\d+;)|(?:O;)?|(?:[A-Za-z0-9=]+;)*)*$/){   
