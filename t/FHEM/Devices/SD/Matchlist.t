...
my $mock_logger = mock 'FHEM::Devices::SD::Logger' => (
    add => [
        Log => sub { return 1; }
    ]
);
...
my $mock_clients = mock 'FHEM::Devices::SD::Clients' => (
    add => [
...
subtest 'getMatchListasRef' => sub {
    plan(4);
    my $matchlist = FHEM::Devices::SD::Matchlist::getMatchListasRef();
...
subtest 'UpdateMatchList' => sub {
    ...
    FHEM::Devices::SD::Matchlist::UpdateMatchList($hash, $user_list);
    ...
    FHEM::Devices::SD::Matchlist::UpdateMatchList($hash, 'invalid');
...
subtest 'UpdateFromClients' => sub {
    ...
    FHEM::Devices::SD::Matchlist::UpdateFromClients($hash);
    ...
    my $res = FHEM::Devices::SD::Matchlist::UpdateFromClients('not a hash');
