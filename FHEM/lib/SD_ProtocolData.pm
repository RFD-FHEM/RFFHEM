...
package lib::SD_ProtocolData;
{
  ...
  our %protocols = (
    ...
    "115" =>  ## BRESSER 6-in-1 Weather Center, Bresser new 5-in-1 sensors 7002550 - elektron-bbs 2021-07-30
              # https://github.com/RFD-FHEM/RFFHEM/issues/607#issuecomment-888542022
      {
        name            => 'Bresser 6in1',
