...
subtest 'test ConvLaCrosse, not hexadezimal' => sub 	{
	...
	like(dies { FHEM::Devices::SIGNALduino::SD_Protocols::ConvLaCrosse('TEST',$hexMsg) } ,qr/ConvLaCrosse, Usage: Input #1, 010503B7PA1041AAAAAAAAPF is not valid HEX/,'check not hexadezimal');
};
