##############################################
# $Id: 14_SD_WS07.pm 21666 2022-12-23 09:29:50Z sidey79 $
# 
...
=for :application/json;q=META.json 14_SD_WS07.pm
{
  ...
  "resources": {
    ...
    "x_testData": [
      {
        "url": "https://raw.githubusercontent.com/RFD-FHEM/RFFHEM/master_fix_tests_JSON/t/FHEM/14_SD_WS07/testData.json",
